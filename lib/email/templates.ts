...
export function practitionerWelcome(
  ...
  return {
    ...
    body: lines(
      ...
      "",
      "Session Standee — get it printed locally and have it visible at every session. You can get the actual cost reimbursed up to a maximum of ₹2,500 along with your first invoice.",
      "",
      "You'll also receive a branded iqcommune T-shirt within 2–3 weeks — do wear it when you're delivering a session.",
      "",
