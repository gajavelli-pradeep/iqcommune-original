...
export function practitionerWelcome(
  ...
  return {
    ...
    body: lines(
      `Dear ${firstName},`,
      "",
      "We are pleased to confirm that your agreement is in, and you are now officially empanelled as an iqcommune practitioner. As session requests come in that match your profile and city, we will reach out to check your availability before confirming anything. You are never obligated to accept a session, and there is no minimum commitment on your end.",
      "",
      `Your empanelment reference: ${practitionerReference}`,
      "",
      "A copy of your countersigned agreement is attached for your records, along with a few things to help you get session-ready:",
      "",
      "Dos & Don'ts — a quick reference for what to cover and what to keep in mind in every session you deliver: a brief self-intro, no product or fund pitching, participant confidentiality, and punctuality. Worth a read before your first session.",
      "",
      "Practitioner Pride — if you're feeling as excited as we are, feel free to share this on your social media to mark the occasion. Entirely your call, never an expectation.",
      "",
      "Session Standee — get it printed locally and have it visible at every session. You can get the actual cost reimbursed up to a maximum of ₹2,500 along with the invoice of first session you take up. Please note, reimbursement shall be processed only upon submission of original receipt.",
      "",
      "You'll also receive a branded iqcommune T-shirt before your first session — do wear it when you're delivering a session.",
      "",
