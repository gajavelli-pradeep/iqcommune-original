const STYLES: Record<string, { bg: string; color: string; border: string; dot: string }> = {
  ...
  Empanelled:        { bg: "#eef7ee", color: "#1a4a1a", border: "#639922", dot: "#3b6d11" },
  Rejected:          { bg: "#fdf0f0", color: "#a32d2d", border: "#f0b0b0", dot: "#a32d2d" },
  ...
  Completed:         { bg: "#eef7ee", color: "#1a4a1a", border: "#639922", dot: "#1a4a1a" },
