...
export const LANDING_PENDING: PendingUnit[] = [
  {
    unit: "P1 · CtaSection",
    reason: "found by this gate — absent from the P1 section list, spec line 1487",
    kind: "pending",
    matches: exactly(
      "Get Started",
  ...
  {
    unit: "P1 · ToolsCalculators 2-6",
    reason: "five of six calculators pending — see docs/spec/tools-calculators.md",
    kind: "pending",
    matches: either(
      exactly(
        "Current age",
